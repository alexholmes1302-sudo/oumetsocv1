...
const SITE = {
  ...
  termcard: {
    ...
    events: [
      { week: "Week 0", date: "Oct 10th", title: "Welcome Drinks & Freshers' Forecast", speaker: "", desc: "Meet the committee, sign up for the year, and try your hand at a live forecasting competition. Super fun, and there will be drinks/snacks!", tag: "Social", location: "Earth Sciences Department" },
      { week: "Week 1", date: "Oct 17th", title: "Tornado and Storm Research Organisation Conference", speaker: "", desc: "An incredible event, showcasing the latest research in tornado and storm science in the UK. Numerous talks by professional meteorologists and academics", tag: "Conference", location: "Oxford Brookes Conference Hall" },
      { week: "Week 3", date: "Oct 27th", title: "Meteorological Quiz Night", speaker: "", desc: "Fun quiz night ", tag: "Quiz", location: "Earth Sciences Department" },
      { week: "Week 5", date: "Nov 10th", title: "Weather Forecasting Discussion Evening", speaker: "", desc: "A fun, chill night, talking about recent weather events, sharing storm experiences, and more", tag: "Social", location: "Earth Sciences Department" },
      { week: "Week 5", date: "Nov 14th", title: "Joint Bar Crawl with Reading Meteorological Society", speaker: "" , desc: "An opportunity to meet fellow meteorological enthusiasts from Reading - the leading undergraduate meteorology university in the UK.", tag: "Bar Crawl", location: "College Bars" },
      { week: "Week 7", date: "Nov 26th", title: "Meteorological Society Bar Crawl", speaker: "", desc: "Bar Crawl", tag: "Bar Crawl", location: "Oxford College Bars" },
